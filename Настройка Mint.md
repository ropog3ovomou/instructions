...
Выполняйте инструкции одру за другой. Помеченные как необязательные можете пропускать. Строки необходимо скопировать и запускать в терминале (как это сделать смотрите в [командная строка для новичков](https://www.youtube.com/watch?v=qwopGsaNF_Q)).
## Начальная настройка
